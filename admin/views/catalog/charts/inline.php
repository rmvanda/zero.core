...
<html>
    ...
    <body class="skin-blue">
        ...
        <!-- jQuery Knob -->
        <script src="/framework/zero-lte/js/plugins/jqueryKnob/jquery.knob.js" type="text/javascript"></script>
        <!-- Sparkline -->
        <script src="/framework/zero-lte/js/plugins/sparkline/jquery.sparkline.min.js" type="text/javascript"></script>

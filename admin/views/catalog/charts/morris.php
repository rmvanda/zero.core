...
<html>
    <head>
        ...
        <!-- Morris charts -->
        <link href="/framework/zero-lte/css/morris/morris.css" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
    ...
    <body class="skin-blue">
        ...
        <script src="/framework/zero-lte/js/plugins/morris/morris.min.js" type="text/javascript"></script>

...
<html>
    <head>
        ...
        <!-- DATA TABLES -->
        <link href="/framework/zero-lte/css/datatables/dataTables.bootstrap.css" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
    ...
    <body class="skin-blue">
        ...
        <!-- DATA TABES SCRIPT -->
        <script src="/framework/zero-lte/js/plugins/datatables/jquery.dataTables.js" type="text/javascript"></script>
        <script src="/framework/zero-lte/js/plugins/datatables/dataTables.bootstrap.js" type="text/javascript"></script>
        <!-- AdminLTE App -->

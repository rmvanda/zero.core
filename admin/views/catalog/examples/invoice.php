                ...
                <section class="content invoice">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h2 class="page-header">
                                ...
                                <small class="pull-right">Date:/framework/zero-lte/2014</small>
                            </h2>
                        </div><!-- /.col -->
                    </div>
                    <!-- info row -->
                    <div class="row invoice-info">
                        ...
                        <div class="col-sm-4 invoice-col">
                            ...
                            <b>Payment Due:</b>/framework/zero-lte/2014<br/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            ...
                            <img src="/framework/zero-lte/img/credit/visa.png" alt="Visa"/>
                            <img src="/framework/zero-lte/img/credit/mastercard.png" alt="Mastercard"/>
                            <img src="/framework/zero-lte/img/credit/american-express.png" alt="American Express"/>
                            <img src="/framework/zero-lte/img/credit/paypal2.png" alt="Paypal"/>
                            <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
                                Etsy doostang zoodles disqus groupon greplin oooj voxy zoodles, weebly ning heekya handango imeem plugg dopplr jibjab, movity jajah plickers sifteo edmodo ifttt zimbra.
                            </p>
                        </div><!-- /.col -->
                        <div class="col-xs-6">
                            <p class="lead">Amount Due/framework/zero-lte/2014</p>

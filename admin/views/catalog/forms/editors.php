...
<html>
    <head>
        ...
        <link href="/framework/zero-lte/css/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class="skin-blue">
        ...
        <!-- Bootstrap WYSIHTML5 -->
        <script src="/framework/zero-lte/js/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js" type="text/javascript"></script>
